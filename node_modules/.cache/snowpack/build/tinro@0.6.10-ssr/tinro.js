...
const Route = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if ($$props.redirect === void 0 && $$bindings.redirect && redirect !== void 0) $$bindings.redirect(redirect);
	if ($$props.firstmatch === void 0 && $$bindings.firstmatch && firstmatch !== void 0) $$bindings.firstmatch(firstmatch);
	if ($$props.breadcrumb === void 0 && $$bindings.breadcrumb && breadcrumb !== void 0) $$bindings.breadcrumb(breadcrumb);
	...
	return `${showContent
	? `${slots.default ? slots.default({ params, meta }) : ``}`
	: ``}`;
});
